...
exports.generateQuestionsAI = exports.generateQuestionsGroq = void 0;
const generative_ai_1 = require("@google/generative-ai");
const dotenv_1 = __importDefault(require("dotenv"));
dotenv_1.default.config();
// Groq API Call via native fetch (OpenAI compatible endpoint)
const generateQuestionsGroq = async (questionTypes, additionalInstructions, extractedFileContent) => {
...
exports.generateQuestionsGroq = generateQuestionsGroq;
const generateQuestionsAI = async (questionTypes, additionalInstructions, extractedFileContent) => {
    ...
    if (!apiKey) {
        ...
        if (groqApiKey) {
            try {
                const groqResult = await (0, exports.generateQuestionsGroq)(questionTypes, additionalInstructions, extractedFileContent);
...
exports.generateQuestionsAI = generateQuestionsAI;
...
const generateMockQuestions = (questionTypes, additionalInstructions) => {
